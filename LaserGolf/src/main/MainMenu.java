...
public class MainMenu extends JPanel {
	...
	/**
	 * Constructs a main menu given the program's driver and gameManager. The main menu's labels and buttons are initialized.
	...
	public MainMenu(GameManager gameManager) {
		...
		selectLevelButton.addActionListener(e -> {  //when clicked, the user is sent to the select level screen
					gameManager.loadSelectLevelMenu();
			});
	}
}
